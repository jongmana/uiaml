...
== Explanation
The popup symbol represents that another application window. The popup may only be invoked by an link:../smd-associative-link/README.adoc[associative link] and has to be drawn outside of the invoking link:../smd-sitemap/README.adoc[sitemap symbol]. 
