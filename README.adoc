...
In the year 2000 Louis Rosenfeld and Peter Morville published the book "Information Architecture for the world wide web" and introduced Sitemaps and Wireframes as common deliverables of an Information Architect (ia). +
