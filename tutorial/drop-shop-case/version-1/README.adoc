...
If this is the case it might be a better choice to go back to the structure aspect of the site and model them as three separate contentareas. For now however we will go on an model them on a single contentarea, the Shop-Information contentarea.
